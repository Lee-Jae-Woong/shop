...
<!-- 쿠폰적용, 적립금 계산기 화면 -->                     
                        ...
                        <input type="text" id="totalPoint" value="${totalPoint.totalPoint }">
    
 <!-- 계산기 -->
   <!-- <div style="display: none"> -->
   <div>
      <form id="smart" onload="calCulation(smart);">
            <input type='text' name='first' size='7' value="${cal1+cal2 }" onKeyUp=calCulation(smart); readonly>
            <input type='text' name='second' size='7' id="calPoint" value="0" onKeyUp=calCulation(smart);>
            <input type='text' name='third' size='7' id="calCoupon" value="0" onKeyUp=calCulation(smart);>
            <input type='text' name='cpCal' class="cpCal" size='7' value="0" readonly>
            <input type='text' name='pointTotal' class="pointTotal" size='7' value="0" readonly>
            <input type='text' name='totalCal' class="totalCal" size='7' value="${cal1+cal2 }">
